...
//******************************************************************//
      ...
      in_array(4,$valores)?$_SESSION['Dproducto']=1:$_SESSION['Dproducto']=0;

      in_array(5,$valores)?$_SESSION['Mprima']=1:$_SESSION['Mprima']=0;
      in_array(6,$valores)?$_SESSION['Cfabricacion']=1:$_SESSION['Cfabricacion']=0;

      in_array(7,$valores)?$_SESSION['Batida']=1:$_SESSION['Batida']=0;
      in_array(8,$valores)?$_SESSION['cif']=1:$_SESSION['cif']=0;
      //FIN PERMISOS DEL USUARIO   
       ...
       //listar los usuarios
        ...
        //metodo para registrar usuario
   	    public function registrar_usuario($nombre,$apellido,$dui,$telefono,$email,$direccion,$cargo,$usuario,$password1,$password2,$estado,$permisos){
        ...
        //metodo para editar usuario
   	    public function editar_usuario($id_usuario,$nombre,$apellido,$dui,$telefono,$email,$direccion,$cargo,$usuario,$password1,$password2,$estado,$permisos){
   ...
   //si el id_usuario NO tiene registros asociados en las tablas compras y ventas entonces se puede editar todos los campos de la tabla usuarios
     if(is_array($usuario_compras)==true and count($usuario_compras)==0 and is_array($usuario_ventas)==true and count($usuario_ventas)==0){
                ...
                ";
                  ...
                  //si el usuario tiene registros asociados en compras y ventas entonces no se edita el nombre, apellido y dui
        ...
        //mostrar los datos del usuario por el id
          ...
          return $resultado=$sql->fetchAll();
   	    ...
   	    //valida correo y dui del usuario

   	    public function get_dui_correo_del_usuario($dui,$email){
          
          $conectar=parent::conexion();
          parent::set_names();

          $sql="select * from usuarios where dui=? or correo=?";
