   ...
   <div class="modal fade" id="detalle_Dproducto">
           ...
           <!--antes tenia un class="modal-content" y lo cambié por bg-warning para que tuviera fondo blanco, deberia haber sido un color naranja claro pero me salió un color blanco de casualidad--> 
            <div class="bg-warning">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-user-circle" aria-hidden="true"></i> DETALLE DE FORMULA</h4>
              </div>
        ...
        <div class="table-responsive">
             ...
             <div class="box-body">
                        ...
                        <table id="detalle_producto" class="table table-striped table-bordered table-condensed table-hover">
                          ...
                          <tbody>
                            ...
                            <td><h4 id="fecha_Dproducto"></h4><input type="hidden" name="fecha_Dproducto" id="fecha_Dproducto"></td>
