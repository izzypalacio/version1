           ...
           <!--antes tenia un class="modal-content" y lo cambié por bg-warning para que tuviera fondo blanco, deberia haber sido un color naranja claro pero me salió un color blanco de casualidad--> 
            <div class="bg-warning">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-user-circle" aria-hidden="true"></i> Formulas</h4>
              </div>
             ...
             <table id="lista_Dproducto_data" class="table table-bordered table-striped">
                ...
                <thead>
                  ...
                  <th class="not-mobile desktop tablet-p tablet-l" width="10%">Numero de Formula</th>
                   ...
                   <th class="not-mobile desktop tablet-p tablet-l" width="10%">Margen Utilidad</th>
                    ...
                    <!--<th class="all" width="10%">Fecha</th>
                    <th class="all" width="10%">Categoria</th>

                    <th class="not-mobile desktop tablet-p tablet-l" width="10%">Estado</th>

                    <th class="all" width="10%">Detalles</th>-->
                     <th class="not-mobile desktop tablet-p tablet-l" width="10%">Estado</th>
