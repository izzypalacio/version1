   ...
   <div class="modal fade" id="lista_actualizarModal">
           ...
           <!--antes tenia un class="modal-content" y lo cambié por bg-warning para que tuviera fondo blanco, deberia haber sido un color naranja claro pero me salió un color blanco de casualidad--> 
            <div class="bg-warning">
              <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="fa fa-user-circle" aria-hidden="true"></i>Costos de Fabricacion</h4>
              </div>
        ...
        <div class="table-responsive">
             ...
             <div class="box-body">
             <table id="lista_actualizar_data" class="table table-bordered table-striped">
