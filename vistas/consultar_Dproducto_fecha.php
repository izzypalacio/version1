...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Consulta de Formulas por fecha
        ...
        <div class="panel-body">
          ...
          <form class="form-inline">
            ...
            <div class="btn-group text-center">
              <button type="button" class="btn btn-primary" id="btn_Dproducto_fecha"><i class="fa fa-search" aria-hidden="true"></i> Consultar</button>
            </div>
          </form>
        ...
        <div class="col-xs-12">
          ...
          <div class="table-responsive">
            <div class="box-header">
              <h3 class="box-title">Lista de formulas por fecha</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="Dproducto_fecha_data" class="table table-bordered table-striped">
                <thead>
