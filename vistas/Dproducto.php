...
?>
  ...
  ?>
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-6 col-lg-offset-3">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalproducto"><i class="fa fa-search" aria-hidden="true"></i> Buscar Producto</button>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        <input type="text" class="form-control" id="numero_Dproducto" name="numero_Dproducto" value="<?php $codigo = $Dproducto->numero_Dproducto(); ?>" readonly>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-3">
                        <div class="col-lg-5 text-center">
                          <button type="button" id="#" class="btn btn-primary" data-toggle="modal" data-target="#lista_MprimaModal"><i class="fa fa-plus" aria-hidden="true"></i> Agregar Costo de Fabricacion</button>
                        </div>
                      </div>
                ...
                <div class="table-responsive">
                  ...
                  <div class="box-body">
                    ...
                    <div class="boton_registrar">
                      <button type="button" onClick="registrarDproducto()" class="btn btn-primary col-lg-offset-10 col-xs-offset-3" id="btn"><i class="fa fa-save" aria-hidden="true"></i> Registrar Formulas</button>
    ...
    <?php require_once("modal/lista_producto_modal.php"); ?>
    <!--VISTA MODAL PARA AGREGAR PROVEEDOR-->

    <!--VISTA MODAL PARA AGREGAR PRODUCTO-->
    <?php require_once("modal/lista_Mprima_modal.php"); ?>
