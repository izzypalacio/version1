              ...
              <div class="row">
                  ...
                  <div class="col-lg-3">
                     <div class="btn-group text-center">
                      <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalProveedor"><i class="fa fa-plus" aria-hidden="true"></i>  Agregar Proveedor</button>
                     <br>
                     <br>
                     <br>
                     <br>
                 ...
                 <div class="col-lg-3">
                  ...
                  <div class="col-lg-3">
                    ...
                    <select name="tipo_pago" class="col-lg-offset-3 col-xs-offset-2" id="tipo_pago" class="select" maxlength="10" >
                            ...
                            <option value="CHEQUE">Con Cheque</option>
            ...
            <div class="box-body">
              <table id="resultados_footer" class="table table-striped">
                ...
                <tr class="row bg-gray">
                  ...
                  <td class="col-lg-4"><h4>13%</h4><input type="hidden"></td>
                   <!--<td></td>-->
      ...
      <h1 align="center">
       ...
       <div class="panel panel-default">
        ...
        <div class="panel-body">
         ...
         <div class="btn-group text-center">
          <a href="consultar_compras.php" class="btn btn-primary btn-lg" ><i aria-hidden="true"></i> Consultar Compras</a>
         </div>
       </div>
      </div>
