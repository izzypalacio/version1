        ...
        <form method="post" id="usuario_form">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <label>DUI</label>
              <input type="text" name="dui" id="dui" class="form-control" placeholder="DUI" required pattern="{0,10}" />
              ...
              <input type="text" name="telefono" id="telefono" class="form-control" placeholder="Teléfono" required pattern="{0,23}" />
              <br />
              ...
              <textarea cols="60" rows="3" id="direccion" name="direccion" placeholder="Direccion ..." required pattern="^[a-zA-Z0-9_áéíóúñ°\s]{0,200}$">
              </textarea>
              <br />
