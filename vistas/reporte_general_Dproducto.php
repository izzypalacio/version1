...
if (isset($_SESSION["id_usuario"])) {
	...
	$datos = $Dproducto->get_Dproducto_reporte_general();


	$datos_ano = $Dproducto->suma_Dproducto_total_ano();
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="box">
						...
						<div class="">
							...
							<h2 class="reporte_Dproducto_general container-fluid bg-red text-white col-lg-12 text-center mh-50">REPORTE GENERAL DE FORMULAS REALIZADAS</h2>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="box">
						...
						<div class="">
							...
							<h2 class="reporte_Dproducto_general container-fluid bg-primary text-white col-lg-12 text-center mh-50">PORCENTAJE POR AÑO</h2>
